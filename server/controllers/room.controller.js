...
const parseRoomData = (roomData, req) => {
  ...
  ['price', 'originalPrice', 'maxOccupancy', 'bedrooms', 'beds', 'bathrooms', 'showers', 'extraBedCount', 'extraBedPrice', 'maxInventory'].forEach(field => {
  ...
  // Parse JSON fields
  ['amenities', 'datePrices', 'blockedDates'].forEach(field => {
